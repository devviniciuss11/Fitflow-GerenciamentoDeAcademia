        ...
        while(opc2==1){
            ...
            try{
                switch (opc){
                    ...
                    case 5:
                        FuncionarioServico guiFuncionario = new FuncionarioServico();
                        GuiFuncionario guiFuncionario1 = new GuiFuncionario();
                        guiFuncionario1.menu();
                        break;
